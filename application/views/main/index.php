    ...
    <!-- ***** Welcome Area Start ***** -->
    <section class="welcome_area clearfix" id="home" style="background-image: url(assets/landing/img/bg-img/welcome-bg.png)">
        <div class="hero-slides owl-carousel">
            <!-- Single Hero Slides -->
            <div class="single-hero-slide d-flex align-items-end justify-content-center">
                <div class="hero-slide-content text-center">
                    <h2>More Compatible</h2>
                    <h4>Easy interface and excellent service!</h4>
                    <img class="slide-img" src="/assets/landing/img/bg-img/device.png" alt="">
                </div>
            </div>
            <!-- Single Hero Slides -->
            <div class="single-hero-slide d-flex align-items-end justify-content-center">
                <div class="hero-slide-content text-center">
                    <h2>Cheap and reusable</h2>
                    <h4>You could call and send sms to anywhere!</h4>
                    <img class="slide-img" src="/assets/landing/img/bg-img/device.png" alt="">
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="clients-logo-area d-sm-flex align-items-center justify-content-between">
                        <a href="#"><img src="/assets/landing/img/clients-img/1.png" alt=""></a>
                        <a href="#"><img src="/assets/landing/img/clients-img/2.png" alt=""></a>
                        <a href="#"><img src="/assets/landing/img/clients-img/3.png" alt=""></a>
                        <a href="#"><img src="/assets/landing/img/clients-img/4.png" alt=""></a>
                        <a href="#"><img src="/assets/landing/img/clients-img/5.png" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="mosh-features-area section_padding_100 clearfix">
        ...
        <div class="features-img">
            <img src="/assets/landing/img/bg-img/features.png" alt="">
        </div>
    </section>
    <!-- ***** Feature Area End ***** -->
    ...
    <section class="mosh-more-services-area d-sm-flex clearfix">
        <div class="single-more-service-area">
            <div class="more-service-content text-center wow fadeInUp" data-wow-delay=".1s">
                <img src="/assets/landing/img/core-img/trophy.png" alt="">
                <h4>No1 in Sales!</h4>
        ...
        <div class="single-more-service-area">
            <div class="more-service-content text-center wow fadeInUp" data-wow-delay=".4s">
                <img src="/assets/landing/img/core-img/edit.png" alt="">
        ...
        <div class="single-more-service-area">
            <div class="more-service-content text-center wow fadeInUp" data-wow-delay=".7s">
                <img src="/assets/landing/img/core-img/video-camera.png" alt="">
                <h4>Modern Design</h4>
        ...
        <div class="single-more-service-area">
            <div class="more-service-content text-center wow fadeInUp" data-wow-delay="1s">
                <img src="/assets/landing/img/core-img/presentation.png" alt="">
    ...
    <section class="mosh-portfolio-area section_padding_100_0 clearfix">
        ...
        <div class="mosh-portfolio">
            ...
            <div class="single_gallery_item gd">
                <img src="/assets/landing/img/portfolio-img/1.jpg" alt="">
            ...
            <div class="single_gallery_item bi">
                <img src="/assets/landing/img/portfolio-img/2.jpg" alt="">
                <div class="gallery-hover-overlay d-flex align-items-center justify-content-center">
                    <div class="port-hover-text text-center">
                        <h4>DFR Corp. Branding</h4>
                        <a href="#">Brand Identity</a>
            ...
            <div class="single_gallery_item gd bi">
                <img src="/assets/landing/img/portfolio-img/3.jpg" alt="">
                <div class="gallery-hover-overlay d-flex align-items-center justify-content-center">
                    <div class="port-hover-text text-center">
                        <h4>DFR Corp. Branding</h4>
                        <a href="#">Brand Identity</a>
            ...
            <div class="single_gallery_item pho">
                <img src="/assets/landing/img/portfolio-img/4.jpg" alt="">
                <div class="gallery-hover-overlay d-flex align-items-center justify-content-center">
                    <div class="port-hover-text text-center">
                        <h4>DFR Corp. Branding</h4>
                        <a href="#">Brand Identity</a>
            ...
            <!-- Single gallery Item Start -->
            <div class="single_gallery_item pho">
                <img src="/assets/landing/img/portfolio-img/5.jpg" alt="">
                <div class="gallery-hover-overlay d-flex align-items-center justify-content-center">
                    <div class="port-hover-text text-center">
                        <h4>DFR Corp. Branding</h4>
                        <a href="#">Brand Identity</a>
            ...
            <div class="single_gallery_item wd pc">
                <img src="/assets/landing/img/portfolio-img/6.jpg" alt="">
                <div class="gallery-hover-overlay d-flex align-items-center justify-content-center">
                    <div class="port-hover-text text-center">
                        <h4>DFR Corp. Branding</h4>
                        <a href="#">Brand Identity</a>
            ...
            <div class="single_gallery_item wd">
                <img src="/assets/landing/img/portfolio-img/7.jpg" alt="">
                <div class="gallery-hover-overlay d-flex align-items-center justify-content-center">
                    <div class="port-hover-text text-center">
                        <h4>DFR Corp. Branding</h4>
                        <a href="#">Brand Identity</a>
            ...
            <div class="single_gallery_item pc">
                <img src="/assets/landing/img/portfolio-img/8.jpg" alt="">
                <div class="gallery-hover-overlay d-flex align-items-center justify-content-center">
                    <div class="port-hover-text text-center">
                        <h4>DFR Corp. Branding</h4>
                        <a href="#">Brand Identity</a>
    ...
    <section class="mosh-workflow-area section_padding_100_0 clearfix">
        ...
        <div class="workflow-img">
            <img src="/assets/landing/img/core-img/work-progress.png" alt="">
        </div>
